...
The 2 to the 56 to the 56 comes from each key pair having another key pair.
...
Since the time to crack 2DES is 2 to the 57 (The number is from the numbers of keys to check) and we know that the time to decrypt 3DES from 1b is 2 to the 56 to the 56 times 2 to the 56 the time to crack 3DES would be the division of the two numbers. 
